...
export function ResultsPanel() {
  const { calcStatus, calcResult, calcError, resultsPanelExpanded, setResultsPanelExpanded } =
    useStore()
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="flex items-center h-8 px-3 cursor-pointer select-none border-b border-border gap-2"
        onClick={() => setResultsPanelExpanded(!resultsPanelExpanded)}
      >
